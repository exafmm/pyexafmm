...
class Fmm:
    ...
    def upward_pass(self):
        ...
        self.backend['p2m'](
                ...
                x0=self.x0,
                r0=self.r0,
                upward_check_surfaces=self.upward_check_surfaces,
    ...
    def downward_pass(self):
        ...
        for key in self.leaves:
            ...
            self.backend['s2l'](
                ...
                x0=self.x0,
                r0=self.r0,
                downward_check_surfaces=self.downward_check_surfaces,
                nequivalent_points=self.nequivalent_points,
                dc2e_inv_a=self.dc2e_inv_a,
                dc2e_inv_b=self.dc2e_inv_b,
                scale_function=self.scale_function,
            ...
            self.backend['m2t'](
                ...
                x0=self.x0,
                r0=self.r0,
                upward_equivalent_surfaces=self.upward_equivalent_surfaces,
                nequivalent_points=self.nequivalent_points,
                p2p_function=self.p2p_function,
            ...
            self.backend['l2t'](
                ...
                x0=self.x0,
                r0=self.r0,
                downward_equivalent_surfaces=self.downward_equivalent_surfaces,
                nequivalent_points=self.nequivalent_points,
                p2p_function=self.p2p_function,
                gradient_function=self.gradient_function,
            )
